...
public class PeerEvent {
    ...
    public com.wisp.game.share.netty.infos.e_peer_event getE_peer_event() {
        return e_peer_event;
    }

    public void setE_peer_event(com.wisp.game.share.netty.infos.e_peer_event e_peer_event) {
